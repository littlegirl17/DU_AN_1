...
-- Thời gian đã tạo: Th10 25, 2023 lúc 04:58 PM
...
(1, 48, 1, 'cai cuc', '2023-11-24 18:23:23');
...
(11, 'Rau củ quả', 0, 0, 'cat-3.jpg'),
(12, 'Trái cây', NULL, NULL, 'cat-1.jpg'),
(13, 'Loại cá', 1, 1, 'cat-6.png'),
(14, 'Loại thịt ', 2, 1, 'cat-5.jpg');
...
CREATE TABLE `donhang` (
  ...
  `MaTK` int NOT NULL,
  `PhuongThucTT` tinyint NOT NULL DEFAULT '1' COMMENT '1.Trả tiền mặt khi nhận hàng 2. Thanh toán bằng VNPAY 3.Thanh toan vi momo',
...
(95, 'Huynh Kha', 'khakha5087@gmail.com', '0353123771', 'Binh Dinh', '', 1112000, '2023-11-25 23:57:32', 1, 1, 4, 'Organic110298');
...
CREATE TABLE `phanhoi` (
  ...
  `HoTen` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL,
  `Email` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL,
  `NoiDung` varchar(255) COLLATE utf8mb3_unicode_ci NOT NULL,
...
INSERT INTO `phanhoi` (`MaPH`, `HoTen`, `Email`, `NoiDung`, `NgayGui`) VALUES
(4, 'Huynh Kha ', 'khakha5087@gmail.com', 'kHÁ TỐT', '2023-11-23 23:05:24'),
(5, 'bảnh', 'khakha50fc87@gmail.com', 'tốt', '2023-11-23 23:05:38');
...
INSERT INTO `sanpham` (`MaSP`, `TenSP`, `GiaSP`, `HinhAnh`, `TieuDe`, `MoTa`, `MaDM`, `LuotXem`, `GiaGiam`) VALUES
...
(1, 'Huynh Kha', 'Kha', 'khakha5087@gmail.com', 'kkk', 'Binh Dinh', 0, '0353123771', 1, '2023-11-09 23:34:11', 'IMG_0144.JPG'),
(15, 'ff', 'hh', 'khakha50t487@gmail.com', 'cb42e130d1471239a27fca6228094f0e', 'gg', 0, '122553', 0, '2023-11-24 16:48:06', 'ava_user.jpeg');
...
--
ALTER TABLE `donhang`
  MODIFY `MaDH` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96;

--
-- AUTO_INCREMENT cho bảng `phanhoi`
--
ALTER TABLE `phanhoi`
  MODIFY `MaPH` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT cho bảng `sanpham`
--
ALTER TABLE `sanpham`
  MODIFY `MaSP` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT cho bảng `taikhoan`
--
ALTER TABLE `taikhoan`
  MODIFY `MaTK` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
